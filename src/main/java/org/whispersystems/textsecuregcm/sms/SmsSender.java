...
public class SmsSender {
  ...
  static final String SMS_VERIFICATION_TEXT = "Your SecureChat verification code: ";
  static final String VOX_VERIFICATION_TEXT = "Your SecureChat verification code is: ";
